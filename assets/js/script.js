...
function runGame(gameType){
    //creates two numbers randomly, between 1 and 25
...
/**
 * Gets the operands (numbers) and the operator (plus or minus etc)
 * directly from the DOM, it returns the correct answer
 */
...
/**
 * Gets current score for incorrect answers from the DOM and increments by 1
 */
